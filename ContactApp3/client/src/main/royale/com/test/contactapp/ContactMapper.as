package com.test.contactapp
{
   ...
   public class ContactMapper
   {
     ...
     public function recordToDTO(records:ArrayCollection): ArrayList
     {
                ...
                trace(" name:" + record.name);
                    ...
                    trace(" attributes:" + record.attributes);
                     ...
                     trace(" account short type values: " + accountShortType.values);
                       ...
                       var accountCategoryColl:ArrayCollection = accountShortType.values;
                       var titleListColl:ArrayCollection = titleStringType.values;
     ...
     public function DtoToRecord(contacts:ArrayCollection):ArrayCollection
     {
